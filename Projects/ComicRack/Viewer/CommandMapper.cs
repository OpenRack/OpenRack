...
namespace cYo.Projects.ComicRack.Viewer
{
  public class CommandMapper : Component
  {
    ...
    public void Add(CommandHandler ch, params object[] senders) => this.Add(ch, (UpdateHandler) null, senders);
    ...
    public void AddService<T>(Control c, ServiceCommandHandler<T> ch, params object[] senders) where T : class => this.AddService<T>(c, ch, (ServiceUpdateHandler<T>) null, senders);
    ...
    private class HandleItem
    {
      ...
      public Keys ShortcutKeys => this.Sender is ToolStripMenuItem sender ? sender.ShortcutKeys : Keys.None;
    }
  }
}
