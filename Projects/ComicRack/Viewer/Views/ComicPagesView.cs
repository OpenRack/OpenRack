...
namespace cYo.Projects.ComicRack.Viewer.Views
{
  public class ComicPagesView : SubView, IDisplayWorkspace, IRefreshDisplay, IItemSize
  {
    ...
    private void filterMenu_ValueChanged(object sender, EventArgs e) => this.PageFilter = (ComicPageType) this.filterMenu.Value;
    ...
    private void tbbGroup_ButtonClick(object sender, EventArgs e) => this.pagesView.ItemView.GroupSortingOrder = ItemView.FlipSortOrder(this.pagesView.ItemView.GroupSortingOrder);

    private void tbbSort_ButtonClick(object sender, EventArgs e) => this.pagesView.ItemView.ItemSortOrder = ItemView.FlipSortOrder(this.pagesView.ItemView.ItemSortOrder);
