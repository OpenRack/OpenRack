...
namespace cYo.Projects.ComicRack.Viewer.Views
{
  public class ComicExplorerView : SubView, ISidebar
  {
    ...
    private void browserControl_BookListChanged(object sender, EventArgs e) => this.comicBrowser.BookList = this.comicListBrowser.BookList;

    private void ItemView_SelectedIndexChanged(object sender, EventArgs e) => this.RestartPreviewTimer();
    ...
    private void pluginContainer_ExpandedChanged(object sender, EventArgs e) => this.UpdatePreview();
    ...
    private void previewBookChanged(object sender, BookChangedEventArgs e) => this.RestartPreviewTimer();

    private void smallComicPreview_CloseClicked(object sender, EventArgs e) => ((ISidebar) this).Preview = false;
    ...
    {
      get => this.pluginContainer.Dock == DockStyle.Right ? new System.Drawing.Size(this.pluginContainer.ExpandedWidth, this.infoBrowserSize.Height) : new System.Drawing.Size(this.infoBrowserSize.Width, this.pluginContainer.ExpandedWidth);
      set
      {
