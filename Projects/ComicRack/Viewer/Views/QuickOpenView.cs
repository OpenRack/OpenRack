...
namespace cYo.Projects.ComicRack.Viewer.Views
{
  public class QuickOpenView : CaptionControl
  {
    ...
    public void EndUpdate() => this.comicPageContainer.ShowInfo((IEnumerable<ComicBook>) this.itemView.Items.OfType<CoverViewItem>().Select<CoverViewItem, ComicBook>((Func<CoverViewItem, ComicBook>) (cvi => cvi.Comic)).ToArray<ComicBook>());
    ...
    public ComicBook SelectedBook => this.itemView.SelectedItems.FirstOrDefault<IViewableItem>() is CoverViewItem coverViewItem ? coverViewItem.Comic : (ComicBook) null;
    ...
    private void itemView_SelectedIndexChanged(object sender, EventArgs e) => this.btOpen.Enabled = this.SelectedBook != null;
    ...
    private void itemView_VisibleChanged(object sender, EventArgs e) => this.btOpen.Visible = this.itemView.Visible;
