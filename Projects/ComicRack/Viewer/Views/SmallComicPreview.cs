...
namespace cYo.Projects.ComicRack.Viewer.Views
{
  public class SmallComicPreview : CaptionControl, IRefreshDisplay
  {
    ...
    private void Settings_DisplayOptionsChanged(object sender, EventArgs e) => this.UpdateSettings();

    private void UpdateSettings() => this.pageViewer.ImageBackgroundMode = ImageBackgroundMode.Color;
    ...
    public bool TwoPageDisplay
    {
      ...
      set => this.pageViewer.PageLayout = value ? PageLayoutMode.DoubleAdaptive : PageLayoutMode.Single;
    }
