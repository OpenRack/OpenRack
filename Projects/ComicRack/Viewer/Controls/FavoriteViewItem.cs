...
namespace cYo.Projects.ComicRack.Viewer.Controls
{
  public class FavoriteViewItem : ThumbnailViewItem
  {
    ...
    public override ItemViewStates GetOwnerDrawnStates(ItemViewMode displayType) => ItemViewStates.All;

    public override ThumbnailKey ThumbnailKey => new ThumbnailKey((object) this, this.ComicListItem.Id.ToString(), 0, ImageRotation.None);
    ...
    public static FavoriteViewItem Create(ComicListItem item) => new FavoriteViewItem()
    {
      ComicListItem = item
    };
  }
