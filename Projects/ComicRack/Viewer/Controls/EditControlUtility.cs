...
namespace cYo.Projects.ComicRack.Viewer.Controls
{
  public static class EditControlUtility
  {
    ...
    public static void SetLabel(Label label, string text) => EditControlUtility.SetLabel(label, text, true);
    ...
    public static void SetText(Control control, int value) => control.Text = value == -1 ? string.Empty : value.ToString();

    public static void SetText(Control control, float value) => control.Text = (double) value == -1.0 ? string.Empty : value.ToString();

    public static void SetText(Control c, bool value) => c.Text = value ? ComicInfo.YesText : ComicInfo.NoText;
