...
namespace cYo.Projects.ComicRack.Viewer.Controls
{
  ...
  {
    public override ItemViewStates GetOwnerDrawnStates(ItemViewMode displayType) => ItemViewStates.Selected | ItemViewStates.Hot;

    public override ThumbnailKey ThumbnailKey => new ThumbnailKey((object) this, this.Text, 0, ImageRotation.None);
