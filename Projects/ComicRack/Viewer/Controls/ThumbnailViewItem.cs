...
namespace cYo.Projects.ComicRack.Viewer.Controls
{
  public abstract class ThumbnailViewItem : ItemViewItem, IDisposable
  {
    ...
    public IItemLock<ThumbnailImage> GetThumbnail(bool memoryOnly) => this.GetThumbnail(this.ThumbnailKey, memoryOnly);
    ...
    protected virtual System.Drawing.Size GetEstimatedSize(System.Drawing.Size canvasSize) => System.Drawing.Size.Empty;
    ...
    protected System.Drawing.Size AddBorder(System.Drawing.Size size) => size + this.border + this.border;
    ...
    protected void AddClickRegion(Rectangle bounds, Action<Rectangle, System.Drawing.Point> click) => this.clickRegions = this.clickRegions.SafeAdd<ThumbnailViewItem.ClickRegion>(new ThumbnailViewItem.ClickRegion()
    {
      Bounds = bounds,
      Click = click
    });
