...
namespace cYo.Projects.ComicRack.Viewer
{
  public class OptimizedProfessionalColorTable : ProfessionalColorTable
  {
    ...
    public override Color MenuItemSelectedGradientEnd => Color.FromArgb(128, this.MenuItemSelectedGradientBegin);

    public override Color ButtonSelectedGradientEnd => Color.FromArgb(128, this.ButtonSelectedGradientBegin);
  }
}
