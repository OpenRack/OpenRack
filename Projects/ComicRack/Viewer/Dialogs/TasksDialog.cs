...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class TasksDialog : Form
  {
    ...
    private Image GetImage(string imageKey) => this.imageCache.Get(imageKey, (Func<string, Image>) (k => (Image) Resources.ResourceManager.GetObject(imageKey)));
    ...
    private void lvTasks_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e) => e.DrawDefault = true;
