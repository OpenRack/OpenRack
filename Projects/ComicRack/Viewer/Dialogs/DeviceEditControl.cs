...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class DeviceEditControl : UserControl
  {
    ...
    private void Database_ComicListCachesUpdated(object sender, EventArgs e) => this.tvSharedLists.Invalidate();

    private void library_ComicListsChanged(object sender, ComicListItemChangedEventArgs e) => this.tvSharedLists.Invalidate();
    ...
    public void SelectList(Guid id) => this.tvSharedLists.SelectedNode = this.tvSharedLists.Nodes.Find((Predicate<TreeNode>) (tn => ((DeviceEditControl.TagElement) tn.Tag).Item.Id == id));

    public void CopyShareSettings() => Clipboard.SetData("DeviceSyncSettings", (object) this.Settings);
    ...
    private void chkOptimizeSize_CheckedChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.OptimizePortable = this.chkOptimizeSize.Checked));

    private void chkOnlyUnread_CheckedChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.OnlyUnread = this.chkKeepLastRead.Enabled = this.chkOnlyUnread.Checked));

    private void chkKeepLastRead_CheckedChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.KeepLastRead = this.chkKeepLastRead.Checked));

    private void chkOnlyChecked_CheckedChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.OnlyChecked = this.chkOnlyChecked.Checked));
    ...
    private void cbLimitType_SelectedIndexChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.LimitValueType = (DeviceSyncSettings.LimitType) this.cbLimitType.SelectedIndex));

    private void cbLimitSort_SelectedIndexChanged(object sender, EventArgs e) => this.SetSelectedListProperty((Action<DeviceSyncSettings.SharedListSettings>) (l => l.ListSortType = (DeviceSyncSettings.ListSort) this.cbLimitSort.SelectedIndex));
    ...
    private ComicListItem GetSelectedComicListItem() => DeviceEditControl.GetComicListItem(this.tvSharedLists.SelectedNode);

    private DeviceSyncSettings.SharedList GetSelectedSharedList() => DeviceEditControl.GetSharedList(this.tvSharedLists.SelectedNode);
    ...
    private void SetSelectedListProperty(Action<DeviceSyncSettings.SharedListSettings> set) => this.SetListProperty(this.tvSharedLists.SelectedNode, set);

    private DeviceSyncSettings.SharedList CreateDefaultSharedList(Guid id) => new DeviceSyncSettings.SharedList(id, this.DefaultListSettings);
