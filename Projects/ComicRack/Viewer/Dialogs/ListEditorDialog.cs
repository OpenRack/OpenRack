...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class ListEditorDialog : Form
  {
    ...
    public object SelectedItem => this.lvItems.SelectedItems.Count != 0 ? this.lvItems.SelectedItems[0].Tag : (object) null;
    ...
    private void btMoveBottom_Click(object sender, EventArgs e) => this.MoveSelected(this.Items.Count - 1, true);
