...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class ExportComicsDialog : Form
  {
    ...
    private void tbQuality_ValueChanged(object sender, EventArgs e) => this.toolTip.SetToolTip((Control) this.tbQuality, this.tbQuality.Value.ToString());
    ...
    private void enumUtil_ValueChanged(object sender, EventArgs e) => this.txRemovedPages.Text = this.enumUtil.Text;

    private void btRemovePageFilter_Click(object sender, EventArgs e) => this.contextRemovePageFilter.Show((Control) this.btRemovePageFilter, 0, this.btRemovePageFilter.Height);
      ...
      ExportSetting setting)
    {
      using (ExportComicsDialog container = new ExportComicsDialog())
      {
        ...
        ExportSetting exportSetting = container.ShowDialog(parent) == DialogResult.OK ? container.Setting : (ExportSetting) null;
