...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class MatcherEditor : UserControl, IMatcherEditor
  {
    ...
    private void rtfMatchValue_Leave(object sender, EventArgs e) => this.currentComicBookMatcher.MatchValue = this.rtfMatchValue.Text;

    private void rtfMatchValue2_Leave(object sender, EventArgs e) => this.currentComicBookMatcher.MatchValue2 = this.rtfMatchValue2.Text;

    private void chkNot_CheckedChanged(object sender, EventArgs e) => this.currentComicBookMatcher.Not = this.chkNot.Checked;

    private void btMatcher_Click(object sender, EventArgs e) => Program.CreateComicBookMatchersMenu((Action<ComicBookValueMatcher>) (newMatcher =>
    {
    ...
    public void AddRule() => this.matchers.Insert(this.matchers.IndexOf((ComicBookMatcher) this.currentComicBookMatcher) + 1, (ComicBookMatcher) this.currentComicBookMatcher.Clone());
