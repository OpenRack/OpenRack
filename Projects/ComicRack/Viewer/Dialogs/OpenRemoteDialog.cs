...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class OpenRemoteDialog : Form
  {
    ...
    private void cbServer_TextUpdate(object sender, EventArgs e) => this.CurrentItem = this.cbServer.Items.OfType<RemoteShareItem>().FirstOrDefault<RemoteShareItem>((Func<RemoteShareItem, bool>) (n => n.Name == this.cbServer.Text)) ?? new RemoteShareItem(this.cbServer.Text);
