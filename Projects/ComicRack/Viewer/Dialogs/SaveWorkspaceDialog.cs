...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class SaveWorkspaceDialog : Form
  {
    ...
    private void ValidateData(object sender, EventArgs e) => this.btOK.Enabled = (this.chkWindowLayouts.Checked || this.chkListLayouts.Checked || this.chkComicDisplayLayout.Checked || this.chkComicDisplaySettings.Checked) && !string.IsNullOrEmpty(this.txtName.Text);
