...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class SmartListDialog : Form, ISmartListDialog
  {
    ...
    private void cbMatchMode_SelectedIndexChanged(object sender, EventArgs e) => this.SmartComicList.MatcherMode = this.cbMatchMode.SelectedIndex == 0 ? MatcherMode.And : MatcherMode.Or;

    private void chkLimit_CheckedChanged(object sender, EventArgs e) => this.SmartComicList.Limit = this.txLimit.Enabled = this.cbLimitType.Enabled = this.chkLimit.Checked;

    private void cbLimitType_SelectedIndexChanged(object sender, EventArgs e) => this.SmartComicList.LimitType = (ComicSmartListLimitType) this.cbLimitType.SelectedIndex;
    ...
    private void txtName_TextChanged(object sender, EventArgs e) => this.SmartComicList.Name = this.txtName.Text.Trim();

    private void txtNotes_TextChanged(object sender, EventArgs e) => this.SmartComicList.Description = this.txtNotes.Text.Trim();

    private void chkNotBaseList_CheckedChanged(object sender, EventArgs e) => this.SmartComicList.NotInBaseList = this.chkNotBaseList.Checked;

    private void chkQuickOpen_CheckedChanged(object sender, EventArgs e) => this.SmartComicList.QuickOpen = this.chkQuickOpen.Checked;

    private void chkShowNotes_CheckedChanged(object sender, EventArgs e) => this.ShowNotes(this.chkShowNotes.Checked);
    ...
    private Control CreateMatchPanel(ComicBookValueMatcher matcher, int width) => (Control) new MatcherEditor(this.smartComicList.Matchers, matcher, 0, width);

    private Control CreateGroupMatchPanel(ComicBookGroupMatcher matcher, int width) => (Control) new MatcherGroupEditor(this.smartComicList.Matchers, matcher, 0, width);
