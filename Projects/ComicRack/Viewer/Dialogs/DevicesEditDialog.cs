...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class DevicesEditDialog : Form
  {
    ...
    {
      get => (IList<DeviceSyncSettings>) this.tabDevices.TabPages.Cast<TabPage>().Select<TabPage, DeviceSyncSettings>((Func<TabPage, DeviceSyncSettings>) (tp => ((DeviceEditControl) tp.Tag).Settings)).ToList<DeviceSyncSettings>();
      set
      {
    ...
    private void btDevice_Click(object sender, EventArgs e) => this.cmDevice.Show((Control) this.btDevice, new System.Drawing.Point(this.btDevice.Width, this.btDevice.Height), ToolStripDropDownDirection.BelowLeft);
