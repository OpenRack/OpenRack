...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class ListLayoutDialog : Form
  {
    ...
    private void btDefaultTile_Click(object sender, EventArgs e) => this.SetTileTextElements(ComicTextElements.DefaultFileComic);
    ...
    private static int GetCaptionId(ComboBox cb) => cb.SelectedItem is ListLayoutDialog.CaptionData selectedItem ? selectedItem.Id : -1;
    ...
    private int SelectedColumnIndex() => this.lvColumns.SelectedIndices.Count <= 0 ? -1 : this.lvColumns.SelectedIndices[0];
