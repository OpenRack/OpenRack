...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class ComicDataPasteDialog : Form
  {
    ...
    public IEnumerable<string> GetChecks() => (IEnumerable<string>) this.GetControls<CheckBox>().Where<CheckBox>((Func<CheckBox, bool>) (cb => cb.Enabled)).Where<CheckBox>((Func<CheckBox, bool>) (cb => cb.Checked && cb.Tag != null)).Select<CheckBox, string>((Func<CheckBox, string>) (cb => (string) cb.Tag)).ToArray<string>();
      ...
      IEnumerable<ComicBook> books)
    {
      ...
      string[] strArray = Program.Settings.ShowCustomBookFields ? Program.Database.CustomValues.Where<string>((Func<string, bool>) (k => Program.ExtendedSettings.ShowCustomScriptValues || !k.Contains<char>('.'))).ToArray<string>() : (string[]) null;
