...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
  public class NewsDialog : Form
  {
    ...
    private void listNewItems_SelectedIndexChanged(object sender, EventArgs e) => this.ShowItem(this.listNewItems.FocusedItem);
    ...
    private void chkNewsStartup_CheckedChanged(object sender, EventArgs e) => Program.Settings.NewsStartup = this.chkNewsStartup.Checked;
