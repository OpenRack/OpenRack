...
namespace cYo.Projects.ComicRack.Viewer.Config
{
  ...
  public class Settings : ICacheSettings, IComicUpdateSettings, ISharesSettings
  {
    ...
    public DisplayWorkspace GetWorkspace(string name) => string.IsNullOrEmpty(name) ? (DisplayWorkspace) null : this.workspaces.FirstOrDefault<DisplayWorkspace>((Func<DisplayWorkspace, bool>) (ws => string.Equals(ws.Name, name, StringComparison.OrdinalIgnoreCase)));
    ...
    public bool IsSharing => this.shares.Any<ComicLibraryServerConfig>((Func<ComicLibraryServerConfig, bool>) (sc => sc.IsValidShare));
    ...
    public bool TrueRightToLeftReading
    {
      ...
      set => this.RightToLeftReadingMode = value ? RightToLeftReadingMode.FlipParts : RightToLeftReadingMode.FlipPages;
    }
    ...
    public List<Settings.RemoteExplorerViewSettings> RemoteExplorerViewSettingsList => this.remoteExplorerViewSettingsList;
    ...
    public ComicExplorerViewSettings GetRemoteExplorerViewSetting(Guid id) => this.RemoteExplorerViewSettingsList.FirstOrDefault<Settings.RemoteExplorerViewSettings>((Func<Settings.RemoteExplorerViewSettings, bool>) (s => s.Id == id))?.Settings;
    ...
    public bool IsActivated => !string.IsNullOrEmpty(this.UserEmail) && Password.Verify(Environment.MachineName + this.UserEmail + (object) this.ValidationDate, this.ValidationKey);
    ...
    public void ResetTwitter() => this.TwitterOAuthToken = this.TwitterAccessToken = this.TwitterUserId = this.TwitterScreenName = (string) null;
    ...
    public void Fix() => this.Devices.ForEach((Action<DeviceSyncSettings>) (d => d.Lists.RemoveAll<DeviceSyncSettings.SharedList>((Predicate<DeviceSyncSettings.SharedList>) (sl => sl == null))));
