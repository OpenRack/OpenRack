...
namespace cYo.Projects.ComicRack.Viewer.Config
{
  public class RemoteShareItem
  {
    ...
    public override bool Equals(object obj) => obj is RemoteShareItem remoteShareItem && remoteShareItem.Name == this.Name && remoteShareItem.Uri == this.Uri;

    public override int GetHashCode() => (this.Name ?? string.Empty).GetHashCode() ^ (this.Uri ?? string.Empty).GetHashCode();
  }
}
