...
namespace cYo.Projects.ComicRack.Viewer.Config
{
  ...
  public class DisplayWorkspace : IComparable<DisplayWorkspace>, INamed, IDescription
  {
    ...
    public BookPageLayout Layout => !Screen.PrimaryScreen.IsLandscape() ? this.PortraitLayout : this.LandscapeLayout;
    ...
    public void SetType(WorkspaceType type, bool set) => this.Type = this.Type.SetMask<WorkspaceType>(type, set);
