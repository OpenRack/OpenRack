...
namespace cYo.Projects.ComicRack.Viewer
{
  ...
  public class NewsStorage
  {
    ...
    public bool HasUnread => this.Items.Find((Predicate<NewsChannelItem>) (item => !this.NewsChannelItemInfos[item].IsRead)) != null;

    public NewsStorage.SubscriptionCollection Subscriptions => this.subscriptions;

    public NewsStorage.NewsChannelItemInfoCollection NewsChannelItemInfos => this.newsChannelItemInfos;
    ...
    public void MarkAllRead() => this.Items.ForEach((Action<NewsChannelItem>) (item => this.NewsChannelItemInfos[item].IsRead = true));
